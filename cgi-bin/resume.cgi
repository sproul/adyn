...
$__employers{"BEA"} = "<b>7/2003--5/2008 Senior Software Engineer for \n<a href='http://www.bea.com'>BEA</a> (formerly Plumtree Software), San Francisco, CA</b>";
$__employers{"Monroe"} = "<b>2/2003--7/2003 Web Application Consultant for\n<a href=http://www.monroesecurities.com/>Monroe Financial Partners</a>, Chicago, IL</b>";
...
$__employers{"ibm"} = "<b>5/1985--12/1985, 6/1986--8/1986 Intern Systems Programmer for I.B.M. Poughkeepsie, NY</b>";
...
[
"Oracle", 1,
" <b>Lab Manager health monitor and disk manager</b>: designed and implemented crons to monitor logs and react to problems.  <ul><li>For well understood user errors, automatically e-mail users explaining what went wrong and how to avoid or rectify problems.</li><li>Automatically constrain hypervisor consumption of congested disks where appropriate.</li><li>Forward mysterious errors to admins with URLs of the relevant objects.</li></ul>Implemented in Ruby, Java and Unix shell."
],
[
"Oracle", 1,
" <b>Process Monitor</b>: designed and implemented internal web site and underlying tools to monitor crons, servers, and networks within the Oracle development infrastructure.  Tools implemented in Unix shell, Perl and Ruby.  UI implemented using Ruby on the server and jquery on the client, notifying users of machine outages, poor performance, server failures, full disks, and logged errors of various kinds."
],
[
"Oracle", 1,
" <b>VMware Lab Manager farm management tools</b>: architected and implemented tooling to control, configure and monitor Oracle's \n<a href=http://www.google.com/search?hl=en&q=vmware+Lab+Manager&btnG=Google+Search>VMware's Lab Manager</a> farm.  \nThese tools support <ul><li>The movement of VMs from one datastore to another, automatically updating linked clone chains as appropriate</li><li>The parallel execution of tasks across many ESX servers (e.g., searching for processes, restarting agents, etc.)</li><li>Analysis and exposure of the VM chains on disk</li><li>Analysis of the undocumented database underlying Lab Manager</li><li>Scriptable bulk updates of VMs' contents (e.g., software updates)</li></ul>\n These tools are implemented in Java, Unix shell and Ruby."
],
[
"Oracle", 1,
" <b>Oracle Business Intelligence graphical report comparison software</b>: Designed and implemented injected JavaScript report comparison software to analyze and highlight changes between reports produced by the Oracle Business Intelligence product.  Taking as its input xpath expressions indicating areas of interest in Oracle build reports, this software supports comparisons between the properties of any pair of builds.  This software supports IE, Firefox, and Google Chrome, and uses Google Gears."
],
[
"BEA", 1,
...
[
"Monroe", 1,
" <b>Securities Trading Risk Management Application</b>: Implemented a secure web-based application for tracking and managing the security inventory, trading activities, and capital management of Monroe Financial Partners, a market-making firm.  The software was implemented using server-side JScript (Microsoft JavaScript) ASP pages served by IIS to generate client-side JavaScript, developed under Windows.  The data were stored in MS Access databases, then migrated to MySQL and MS SQL Server.  Integrated with Sungard BRASS data feed to import trade data.  Implemented unit tests using an xUnit (language neutral version of JUnit) framework.  Tuned performance on MS SQL Server.  Configured security under IIS, using SSL.  <a href='/resume/testimony/monroe.html'>User feedback</a> was very positive."
],
[
"Monroe", 1,
...
#
" <b>Adaptive Learning Educational Software</b>:  Designed, implemented and tested \n<a href='http://$__webSite/teacher/summary.html'>Teacher</a>\n, an educational tool for students of foreign languages.  This application allows students to study categories of vocabulary and/or conjugations in any of several languages.  The web site tracks each student's performance across categories of exercises, automatically emphasizing the student's weak areas when selecting new exercises.  Implemented using JavaScript and jquery on the client, and Perl on the server.  Web client optimized for mobile browsers, tested on all major browsers."
],
#[
#"adynware", 0,
...
[
"extensity", 1,
" <b>Java Accounting systems integration</b>:  Designed and implemented Java components integrating Extensity's expense report applications with user accounting packages and HR Sybase, Oracle, and MS SQL servers.  Performance tuning of WebLogic-based application and MS SQL Server, and Oracle queries.  Middleware customizations were implemented in Java using JDBC, SQL, and PL/SQL under Solaris Unix and Windows NT, combined with Apache and IIS.  WebLogic J2EE application servers deployed and tuned for large-scale use by thousands of users at users such as AirTouch (now <a href='http://www.verizon.com'>Verizon</a>), <a href='http://www.incyte.com'>Incyte</a>, <a href='http://www.ogilvy.com'>Ogilvy</a>, and <a href='http://www.hbo.com'>HBO</a>.  <a href='/resume/testimony/ext_airtouch_kelly_al.html'>Client feedback</a> was excellent."
],
[
"extensity", 1,
" <b>Java Accounting systems migration</b>:  Designed and implemented Perl and Unix shell scripts under Solaris Unix and Windows NT to manage the migration of users between major releases.  Integrated and debugged Java conversion software to export data to XML and back in the new release.",
],
[
"extensity", 0,
" <b>JavaScript/Java JVM Sniffer</b>:  Designed, implemented and tested applet to determine Java virtual machine (JVM) vendor and, in the Microsoft case, use Microsoft's proprietary interface to determine the build version; this software would propose updating the JVM when incompatible versions were found.  Implemented in Java and JavaScript under Windows NT, this software was deployed to users whose clients had many versions of the Microsoft JVM in use, only some of which worked correctly with Extensity's products.",
],
[
"extensity", 1,
" <b>Database Management Utilities</b>:  Designed and implemented Unix shell, Perl and LISP scripts to generate SQL load scripts, to restore and Dump MS SQL Server and Oracle databases, and to edit database tables.  <a href='/resume/testimony/extensity_ronan.html'>Client feedback</a> was very positive."
],
[
"adynware.0", 1,
...
[
"sybase", 1,
" <b>Source Code Distribution Shell Script Suite</b>: Designed and implemented a suite of Unix shell scripts to efficiently distribute the Sybase connectivity codeline (around 5000 files) to a set of host machines for build and test, and keep these distributed codelines in sync through incremental updates.  This suite smoothly handles partial network outages and host failures.  <a href='/resume/testimony/sybase_ramiro_codeline.html'>Employer feedback</a> was very positive."
],
[
"sybase", 0,
...
[
"trw", 1,
" <b>C: Image Archiver</b>: Designed, implemented and tested this multi-threaded program under OS/2 in C to archive massive data to hard drives.  Simultaneously driving seven hard drives, this program was able to keep pace with the voluminous output from IBM mainframe image processing peripherals."
],
[
"trw", 0,
...
sub PrintHeader
{
  ...
  print adyn_cgi_util::html_header("Nelson Sproul's resume") . "<style type=\"text/css\"> td { font-family: sans-serif; font-size: 70%;  input {font-size: 80%}}</style>";
