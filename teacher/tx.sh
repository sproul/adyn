...
rm -rf $DROP/adyn/teacher/grammar/gen
chmod -w $DROP/adyn/teacher/grammar
...
ls -l $DROP/adyn/teacher/data/out_base
...
$DROP/adyn/teacher/bin/teacher.regen_cgi_mostCommonVerb
